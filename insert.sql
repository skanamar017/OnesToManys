...
INSERT INTO Pokemon (pokedex_number, name, type1, type2, base_hp, base_attack, base_defense, base_special, base_speed, entry) VALUES
...
INSERT INTO Trainers (name, age, gender, occupation)
VALUES
('Ash', 10, 'Male', 'Pokemon Trainer'),
('Misty', 12, 'Female', 'Water Pokemon Trainer'),
('Brock', 15, 'Male', 'Rock Pokemon Trainer'),
('Lt. Surge', 35, 'Male', 'Electric Pokemon Trainer'),
('Erika', 27, 'Female', 'Grass Pokemon Trainer'),
('Koga', 40, 'Male', 'Poison Pokemon Trainer'),
('Sabrina', 28, 'Female', 'Psychic Pokemon Trainer'),
('Blaine', 50, 'Male', 'Fire Pokemon Trainer'),
('Giovanni', 45, 'Male', 'Ground Pokemon Trainer'),
('Lorelei', 30, 'Female', 'Ice Pokemon Trainer');
